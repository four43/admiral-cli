...
Tty.prototype.flags = function () {
	if (this.cli.flags.length !== 0) {
		...
		this.cli.flags.forEach(function (flag) {
			if(flag.options.shortFlag != null) {
				if(flag.options.longFlag != null) {
					flagOptions.push(["\t", flag.options.shortFlag + ", " + flag.options.longFlag, " ", flag.options.description]);
				}
				else {
					flagOptions.push(["\t", flag.options.shortFlag, " ", flag.options.description]);
				}
			}
			else {
				flagOptions.push(["\t", flag.options.longFlag, " ", flag.options.description]);
			}
		});
