...
Cli.prototype.parse = function (args, elements) {
	...
	try {
		this.params = Cli.parseParams(scriptArgs, elements, {
 ...
 * @throws InvalidInputError
 */
Cli.parseParams = function (args, elements, options) {
	...
	helpers.merge(params, CommandGroup.parse(argsToParse, elements.commandGroups, Cli.parseParams));
